...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/broken-night-4d24
```

A live public deployment of this template is available at [https://broken-night-4d24.templates.workers.dev](https://broken-night-4d24.templates.workers.dev)
